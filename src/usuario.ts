abstract class Usuario {
    ...
    // public devolverEmprestimo(livro: Livro): void {
    ...
    //         emprestimoFeito.getStatus() === "Em curso" && hoje > emprestimoFeito.getDataDevolucao()
    //     );
    // }

    // public podePegarEmprestimo(): boolean {
    //     const emprestimosEmAberto = this.emprestimosFeitos.filter(emprestimoFeito => 
    //         emprestimoFeito.getStatus() === "Em curso"
    //     ).length;
    //     return emprestimosEmAberto < this.regraEmprestimo.limiteEmprestimosEmAberto();
    // }
